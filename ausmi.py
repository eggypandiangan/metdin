...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul 26 06:18:36 2020
...
prec2=prec1.sel(lon=slice(120,150),lat=slice(-7.5,-17.5)).mean(axis=(1,2))    

prec_bln=np.append(prec2[7:12],prec2[0:7])
...
cor[0,0]     
ds.sel(lon=0,lat=88.542)
plt.plot(cor)
prate.data.shape ######################LON DARI 0 KEBESAR
prate.data[:,93,0]  ######################LAT DARI ATAS(0) KE BAWAH (94) > 88.542 ke -88.542
pearsonr(ausmi,prate.sel(lon=0,lat=-88.542))
